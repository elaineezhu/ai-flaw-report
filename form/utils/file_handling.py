    ...
    try:
        ...
        try:
            ...
            try:
                ...
                st.sidebar.error(f"Error creating repository: {create_e}")
        ...
        try:
            ...
            st.sidebar.warning(f"Note: {dir_e}")
            st.sidebar.info("Continuing with file uploads...")
        ...
        for file_path in files:
            ...
            try:
                ...
                st.sidebar.error(f"Error uploading {filename}: {upload_e}")
